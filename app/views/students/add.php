...
<main class="form-signup" style="height: 100% !important;  " >

    <div class="container-signup my-2 p-3 h-25">
        <div class="col-md-6 mx-auto">
            <div class="card card-body-bg-light mb-4">

                <h5 class="mx-auto" class="h3 fw-normal">Add a student</h5>
            </div>
        ...
        <form name="myForm" onsubmit="return validateForm()" action="<?php echo URLROOT; ?>/students/add" method="POST">
            ...
            <div class="form-floating">
                <input type="text" class="my-2 form-control <?php echo (!empty($data['teacher_err'])) ? 'is-invalid' : '';?>"
