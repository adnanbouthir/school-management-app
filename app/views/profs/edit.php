...
<a href="<?php echo URLROOT; ?>/profs" class="btn btn-primary"><i class="fa fa-backward"></i> back to professor</a>
    ...
    <div class="container-signup">
        <div class="col-md-6 mx-auto">
            <div class="card card-body-bg-light mt-5 mb-4">
                ...
                <h5 class="mx-auto" class="h3 mb-3 fw-normal">Edit  professor</h5>
            </div>

        </div>
        <form name="myForm" onsubmit="return validateForm()" action="<?php echo URLROOT; ?>/profs/edit/<?php echo $data['id']?>" method="POST">
        ...
        <div class="form-floating">
            ...
            <div class="form-floating">
                <input type="text" class="my-2 form-control <?php echo (!empty($data['subject_err'])) ? 'is-invalid' : '';?>"
            ...
            <button class="w-100 btn btn-lg btn-primary mb-3 mt-3" type="submit">Edit professor</button>
        </form>
